...
// busca o indice
console.log(fullName.indexOf('S'), 'indexOf')
...
const nameRule = arrayRemember[0] + ' ' + arrayRemember[arrayRemember.length - 1]; //Para escrever Primeiro nome e Ultimo nome
console.log(nameRule)

console.log(arrayRemember[1], 'segundo item do array')

// forma antiga
arrayRemember[4] = 'inseri um item'
console.table(arrayRemember)

// adiciona um item no ultimo lugar usando metodo push
arrayRemember.push('Adicionei usando metodo push')
console.table(arrayRemember)

// vizualizar o ultimo item
...
// adiciona um item no primeiro lugar
